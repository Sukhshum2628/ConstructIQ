...
from modules.cad_parser import _strategy_3_dimensions, _detect_and_confirm_scale, _strategy_0_outline_polylines, _strategy_1_closed_polylines, _strategy_2_hatch, _strategy_4_wall_bbox
...
print(f"Strategy 3: {res3['area']} (conf {res3['confidence']})")
